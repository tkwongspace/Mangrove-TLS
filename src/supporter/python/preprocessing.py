...
out_path = r'D:\SystemRelated\Documents\GitHub\Mangrove-TLS\data\debug_tiles'


print('\n>> Preprocessing Started..')
start_time = time.time()

pc_file = r'E:\Data\PointCloud\FSCT_TEST\ShiPaiDong.las'
...
save_file(filename=os.path.join(out_path, '../preprocessed.las'), pointcloud=pc)
